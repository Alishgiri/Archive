...
class RoundedUnderlineIndicator extends Decoration {
  ...
  const RoundedUnderlineIndicator({
    ...
    this.padding: const EdgeInsets.symmetric(vertical: 0.0, horizontal: 2.0),
  ...
  Decoration lerpFrom(Decoration a, double t) {
    if (a is RoundedUnderlineIndicator) {
      return new RoundedUnderlineIndicator(
  ...
  Decoration lerpTo(Decoration b, double t) {
    if (b is RoundedUnderlineIndicator) {
      return new RoundedUnderlineIndicator(
...
class _BubblePainter extends BoxPainter {
  ...
  Rect _indicatorRectFor(Rect rect, TextDirection textDirection) {
    ...
    return new Rect.fromLTWH(
      indicator.left,
      indicator.bottom - indicator.height,
      indicator.width,
      indicator.height,
    );
  }
